...
class SearchResult extends StatelessWidget {
        ...
        itemBuilder: (BuildContext context, int index) {
          return Text(
            ...
            style: AppTheme.h6Style
                .copyWith(fontSize: 12, color: LightColor.extraDarkPurple),
          );
        });
  }
  ...
  Widget build(BuildContext context) {
    List<Data> searchResultData = ModalRoute.of(context).settings.arguments;
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                ...
                                settings: RouteSettings(
                                    arguments: searchResultData[index])));
                      },
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            _courceInfo(searchResultData[index],
